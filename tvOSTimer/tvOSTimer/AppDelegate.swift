...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    fileprivate func configureAppForFirstLaunchOrNilTSObject() {
        if !UserDefaults.standard.bool(forKey: "FIRST_LAUNCH") || UserDefaults.standard.object(forKey: SettingsConstants.timerSettingsKey) == nil {
